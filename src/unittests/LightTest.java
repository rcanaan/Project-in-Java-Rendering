...
public class LightTest
{
    ...
    public void sphereSpot() {
        ...
        scene.addLights(new SpotLight(new Color(500, 300, 0), new Vector(1, -1, 2),new Point3D(-50, 50, -50)
    ...
    public void trianglesSpot() {
        ...
        scene.addLights(new SpotLight(new Color(500, 250, 250)
               ,new Vector(-2, 2, 1), new Point3D(10, 10, 130),
                1, 0.0001, 0.000005));
    ...
    public void trianglesLightsTest()
    {
        ...
        scene.addLights(new PointLight(new Color(500, 500, 250), new Point3D(20, 10, 130), 1, 0.0001, 0.00025));

        scene.addLights(new SpotLight(new Color(500, 250, 250), new Vector(-2, 2, 1), new Point3D(30, 10, 130), 1, 0.0003, 0.000007));
