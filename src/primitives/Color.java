 ...
 * whatever...
 */
private double _r = 0.0, _g = 0.0, _b = 0.0;//r=red, g=green, b = blue this color right now is black
     ...
     */
    public java.awt.Color getColor()//return color on java format
    {
     ...
     */
    public Color add(Color... colors)//adding few colors into new color
    {
        ...
        return new Color(r, g, b);//returning as a new color, but may be above 255 (would be fixed at "getColor")
    }
     ...
     * @return new Color object which is a result of the operation
     */
    public Color add(java.awt.Color... colors)//adding few colors into new color
    {
        double r = _r, g = _g, b = _b;
     ...
     * @return new Color object which is the result of the operation
     */
    public Color reduce(double k)//fading
    {
        if (k < 1)
